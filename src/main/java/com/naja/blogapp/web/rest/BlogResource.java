...
/**
 * REST controller for managing {@link com.naja.blogapp.domain.Blog}.
 */
@RestController
        ...
        Optional<Blog> result = blogRepository
            ...
            .map(existingBlog -> {
                ...
                if (blog.getMainImage() != null) {
                    existingBlog.setMainImage(blog.getMainImage());
                }
                if (blog.getMainImageContentType() != null) {
                    existingBlog.setMainImageContentType(blog.getMainImageContentType());
                }
                if (blog.getDocument() != null) {
                    existingBlog.setDocument(blog.getDocument());
                }
                if (blog.getDocumentContentType() != null) {
                    existingBlog.setDocumentContentType(blog.getDocumentContentType());
                }
