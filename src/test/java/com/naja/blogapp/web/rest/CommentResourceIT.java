...
import com.naja.blogapp.repository.CommentRepository;
...
class CommentResourceIT {
    ...
    public static Comment createEntity(EntityManager em) {
        Comment comment = new Comment().content(DEFAULT_CONTENT).date(DEFAULT_DATE);
        return comment;
    }
    ...
    public static Comment createUpdatedEntity(EntityManager em) {
        Comment comment = new Comment().content(UPDATED_CONTENT).date(UPDATED_DATE);
        return comment;
    }
    ...
    void putExistingComment() throws Exception {
        ...
        updatedComment.content(UPDATED_CONTENT).date(UPDATED_DATE);
    ...
    void fullUpdateCommentWithPatch() throws Exception {
        ...
        partialUpdatedComment.content(UPDATED_CONTENT).date(UPDATED_DATE);
